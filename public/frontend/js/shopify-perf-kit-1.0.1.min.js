!(function () {
  ...
  const V = '/shopifycloud/privacy-banner/storefront-banner.js',
    X = '/shopifycloud/consent-tracking-api/v0.1/consent-tracking-api.js';
  async function Z() {
