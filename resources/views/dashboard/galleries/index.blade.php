                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('معرض الصور') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('galleries.create') }}" class="btn btn-primary">{{ __('إضافة صورة جديدة') }}</a>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach($galleries as $gallery)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('galleries.edit', $gallery->id) }}" class="btn btn-warning">{{ __('تعديل') }}</a>
